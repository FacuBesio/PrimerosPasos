const StockAndPrice_input = ({ handlerChange, errors, updateProduct }) => {
  const price = updateProduct.price ? `$ ${updateProduct.price}` : `$...`;
    ...
    <div className="w-full px-4 py-1 flex gap-10">
      <div className="w-1/2 flex flex-col gap-2 text-[12px] md:text-[18px]">
        ...
        <input
          ...
          value={updateProduct?.stock ? updateProduct.stock : ""}
