const Categories = () => {
  ...
  const categories = [
    { name: "Diversión", image: "/src/assets/product34.webp", description: "3x2" },
    { name: "Cochecitos", image: "/src/assets/product3.webp", description: "Cuotas sin interes" },
  ...
  return (
    <section className="sm:grid grid-rows-2 grid-cols-2 bg-[#Dbb1bc]">
      {categories.map((cat) => (
        <a key={cat.name} href="/shop" className="   max-h-[360px]  flex border-b-red-100 border-b-2">
          <img className=" w-1/2 border-l-red-200 border-l-1  " src={cat.image} alt="Imagen categorias" />
