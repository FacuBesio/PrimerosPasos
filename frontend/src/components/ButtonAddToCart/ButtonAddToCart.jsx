  ...
  return (
    <div>
      <button
        ...
        className="absolute top-[-22px] right-1 bg-gray-200 w-fit p-1 mt-6 hover:scale-105 hover:bg-red-200 transition-all duration-200 rounded-xl border border-[#Dbb1bc] text-[#393334]"
      >
