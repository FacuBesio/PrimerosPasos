const NameAndEmail_input = ({
  ...
  const inputStyle = editable
    ...
    : "w-full px-4 py-2 bg-gray-200 font-bold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-400";
    ...
    <div className="w-full mt-8 px-4 py-1 flex gap-10">
      ...
      <div className="w-1/2 flex flex-col gap-2">
        ...
        <input
          ...
          id="email"
          name="email"
          className="w-full px-4 py-2 bg-gray-200 font-bold rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-400"
